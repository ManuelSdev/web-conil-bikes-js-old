...
export default function SiteHeader() {
   return (
      <header className="HEADER-1 fixed z-50 flex w-full flex-wrap bg-white py-4 text-sm dark:bg-gray-800 sm:flex-nowrap sm:justify-start">
         <nav
            className="HEADER-2 mx-auto w-full max-w-[85rem] px-4 sm:flex sm:items-center sm:justify-between"
            aria-label="Global"
         >
            {' '}
            {/**LOGO y BOTONERA -sm */}
